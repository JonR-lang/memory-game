  ...
  return (
    <>
      ...
      <div className='min-h-screen overflow-y-auto w-full flex items-center justify-center p-4 flex-col gap-4 text-center dark:custom-bg-mobile dark:sm:custom-bg custom-cursor'>
        ...
        <div className='w-full backdrop-blur-md max-w-md'>
          <div
            className={
              "w-full aspect-square rounded-xl p-3 grid grid-cols-4 place-items-center gap-3 dark:bg-black/40 bg-neutralClrTwo "
            }>
